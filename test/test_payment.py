...
params_add = [(Payment(invoice_number='INV-0001', amount=100, date='2023-09-09 11:00 PM'), InsertStatus.INSERTED_SUCCESSFULLY),
              ...
              (Payment(invoice_number='INV-0005', amount=100, date='2023-09-09 11:00 PM', id_cart=FAKE_DB['Payment'].find_one({})['_id']), InsertStatus.DUPLICATE_ID)]
