...
params_add = [(Appointment(patient=_valid_patient, doctor=_valid_doctor, date='2023-09-09 01:00 AM'),
               InsertStatus.INSERTED_SUCCESSFULLY),
              (Appointment(patient=_valid_patient, doctor=_valid_doctor, date='2023-09-09 01:00 AM'),
               InsertStatus.DUPLICATE_ENTRY),
              (Appointment(), InsertStatus.INCOMPLETE_INFO),
              (Appointment(patient=_valid_patient, doctor=_valid_doctor,
                           id_cart=FAKE_DB['Appointment'].find_one({})['_id']), InsertStatus.DUPLICATE_ID)]

params_find = [
    (Appointment(patient=_valid_patient, doctor=_valid_doctor, date='2023-09-09 01:00 AM'), FindStatus.RECORD_FOUND),
